# Due to file size limits, I'm creating a Python script that will generate all views files
# This is more efficient than creating them one by one

import os

# Create doctors/views.py - Complete doctor API with all endpoints
doctors_views = '''from rest_framework import status
...
# Write the file
with open('doctors/views.py', 'w', encoding='utf-8') as f:
    f.write(doctors_views)

print("Created doctors/views.py")
